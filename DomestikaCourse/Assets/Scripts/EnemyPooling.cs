...
{
    public GameObject prefab; //publico para poner los prefabs
    public int amount = 10; //cantidad de prefabs
    public int instanciateGap = 5; //cada 5 segundos aparece un enemigo del pool
